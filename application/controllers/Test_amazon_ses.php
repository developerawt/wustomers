...
class Test_amazon_ses extends CI_Controller {
	...
	function index() 
	{
		...
		// Set from address
		$this->amazon_ses->from('awt.honest2019@gmail.com');		
		$this->unit->run($this->amazon_ses->from, 'awt.honest2019@gmail.com', 'Set from address', '-');
		
		// Set invalid from address
		$this->amazon_ses->from('awt.honest2019@gmail.com');
		$this->unit->run($this->amazon_ses->from, 'awt.honest2019@gmail.com', 'Set invalid from address', 'Because we provided an invalid address, the previously set address is still set.');
		
		// Set to
		$receipients = 'awt.honest2019@gmail.com';
		$this->amazon_ses->to($receipients);
		$this->unit->run($this->amazon_ses->recipients['to'][0], 'awt.honest2019@gmail.com', 'Set to address (single)', '-'); 
