...
class ResponseMessages{
    ...
    public static function getStatusCodeMessage($status)
    {
        ...
        $codes = Array(
            ...
            110 => "Registered Successfully Done.",
            ...
            141=>  "Old password dose not matched.",
            ...
            518 => "This inventory has been already transfers.",
            ...
            800 => "Data is Available",
            801 => "Data is Unavailable",
            802 => "Social Login Successfully Done.",
            803 => "Login Successfully Done.",
            804 => "Invalid Email/Password.",
            805 => "Invalid Login Credentials.",
            806 => "Driver Have Orders.",
            807 => "Driver Doesn't Have Orders.",
            808 => "Data Updated Successfully.",
            809 => "Data Not Updated.",
            810 => "Data Inserted Successfully.",
            811 => "Data Not Inserted.",
            812 => "Logout Successfully.",
            813 => "Logout Failed.",
            814 => "OTP Verified",
            815 => "OTP Not Verified",
            816 =>"Product Updated Successfully",
            817 =>"Product Not Updated",
            818 =>"Otp Sent To Your Mobile Number",
            819 =>"Otp can't To Your Mobile Number",
            820 =>"Product Has Been Deleted",
            821 =>"Product Cannot Delete",
            822 =>"Shop Detail Updated",
            823 =>"Shop Detail Not Update",
            
            824 =>"Payment status has been successfully updated",
            825 =>"Payment status has not been updated",
            826 =>"Email is already taken",
            827 =>"Shop Name is already taken",
            828 =>"Profile Updated",
