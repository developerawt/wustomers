         ...
         <div class="login_wrapper">
            <div class="animate form login_form">
               ...
               <div class="alert alert-success alert-dismissible">
                  ...
                  <strong><h6><?php echo $this->session->flashdata('mess'); ?><h6></strong> 
                </div>
               <?php }?>
              
                <section>
                  <div class="login-form">
                     <form class="cmxform" id="commentForm" action="<?=site_url('signup/newpass');?>" method="post">
                        ...
                        <div class="form-group">
                           <input type="hidden" class="form-1" id="smscode" value="<?php echo $smscode;?>" name="smscode">
                           <input type="text" class="form-1" id="emailcode" name="newpass"  placeholder="New Password *" required>
                        </div>
