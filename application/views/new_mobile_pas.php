         ...
         <div class="login_wrapper">
            <div class="animate form login_form">
               ...
               <div class="alert alert-success alert-dismissible">
                  ...
                  <strong><h6><?php echo $this->session->flashdata('mail_info'); ?><h6></strong> 
                </div>
               <?php }?>
...
?>
               <section>
                  <div class="login-form">
                     <form class="cmxform" id="commentForm" action="<?=site_url('admin/VerifyNewPassword');?>" method="post">
                        <h3 class="text-center h-l">Verification Code </h3>
                       
                        <div class="form-group">
                           <input type="text" class="form-1" id="emailcode" name="newNumber"  placeholder="Verification code *" required>
                           <input type="hidden" class="form-1" id="emailcode" value="<?php echo $country_id ; ?> " name="country_id"  placeholder="Verification code *" required>
                           <input type="hidden" class="form-1" id="emailcode"  value="<?php echo $CountryCode ; ?>" name="CountryCode"  placeholder="Verification code *" required>
                           <input type="hidden" class="form-1" id="emailcode" value="<?php echo $mobile_number ; ?>"  name="mobile_number"  placeholder="Verification code *" required>
                        </div>
                          <p class="change_link">
