            ...
            <div class="animate form login_form">
               ...
               <section>
                  <div class="login-form">
                     <form class="cmxform" id="commentForm" action="<?=site_url('signup/emailvarfiy');?>" method="post">
                        ...
                        <div class="form-group">
                           <input type="text" class="form-1" id="emailcode" name="emailcode"  placeholder="Verification code *" required>
                        </div>
                          <p class="change_link">
