      ...
      <div>
         ...
         <div class="login_wrapper">
            <div class="animate form login_form">
               ...
               <?php } ?>
                 <?php if($this->session->flashdata('mes')){
                  ?>
               <div class="alert alert-success alert-dismissible">
                  <button type="button" class="close" data-dismiss="alert">&times;</button>
                  <strong><h6><?php echo $this->session->flashdata('mes'); ?><h6></strong> 
                </div>
               <?php }?>
              
                <section>
                  <div class="login-form">
                     <form class="cmxform" id="commentForm" action="<?=site_url('signup/smsvarfiy');?>" method="post">
                        ...
                        <div class="form-group">
                           <input type="hidden" class="form-1" id="emailcode" value="<?php echo $emailcode;?>" name="smscode"  placeholder="Verification code *" required>
                           <input type="text" class="form-1" id="emailcode" name="newpass"  placeholder="Verification code *" required>
                        </div>
                          <p class="change_link">
