      ...
      <html class="no-js" lang="en">
         ...
         <body>
            <!-- Header
               ================================================== -->
            <header id="home">
               <nav id="nav-wrap" style="background-color: #f2f2f2;">
                  <div class="container">
               ...
               <div class="row banner">
                  <div class="banner-text">
                        ...
                        <h1 class="responsive-headline">Special Offer For Weeks</h1>
                     
                     <h3>Customers, and take advantage of seasonal opportunities. Sales promotions are a short-term marketing tactic to create urgency and increase sales.</a>.</h3>
                     <hr />
                     <ul class="social">
            ...
            <section id="portfolio">
               <div class="row">
                  ...
                  <div id="modal-01" class="popup-modal mfp-hide">
                     <img class="scale-with-grid" src="<?=base_url('/assets/temp1/');?>images/portfolio/modals/m-coffee.jpg" alt="" />
                  ...
                  <div id="modal-02" class="popup-modal mfp-hide">
                     <img class="scale-with-grid" src="<?=base_url('/assets/temp1/');?>images/portfolio/modals/m-console.jpg" alt="" />
                     <div class="description-box">
                        <h4>Console</h4>
                        <p>Proin gravida nibh vel velit auctor aliquet. Aenean sollicitudin, lorem quis bibendum auctor, nisi elit consequat ipsum, nec sagittis sem nibh id elit.</p>
                     ...
                     <form class="form-area contact-form text-right" id="myForm" action="https://colorlib.com/preview/theme/travel/mail.php" method="post">
                        <div class="row">
                           <div class="col-lg-6 form-group">
                              <input name="name" placeholder="Enter your name" class="input1 form-control" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter your name'" class="common-input mb-20 form-control" required="" type="text">
                              <input name="email" placeholder="Enter email address"  class="input3 form-control"  pattern="[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Za-z]{1,63}$" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter email address'" class="common-input  form-control" required="" type="email">
                              <input name="subject" placeholder="Enter subject"  class="input1 form-control"  onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter subject'" class="common-input mb-20 form-control" required="" type="text">
                           </div>
                           <div class="col-lg-6 form-group">
                              <textarea class="input1 form-control" name="message" placeholder="Enter Messege" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter Messege'" required=""></textarea>            
                           </div>
                           <div class="col-lg-12">
