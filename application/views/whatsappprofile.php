            ...
            <div class="animate form login_form">
               ...
               <?php } ?>
                 <?php if($this->session->flashdata('WhatsappNumber')){
                  ?>
               <div class="alert alert-success alert-dismissible" id="WhatsappNumber_message" >
               ...
               <?php }?>
                ...
                <section>
                  <div class="login-form">
                     <form class="cmxform" id="commentForm" action="<?=site_url('admin/changeWhatsappNumber');?>" method="post">
                        <h3 class="text-center h-l">Change Whatsapp Number </h3>
                         <p class="text-center p-l"><span style="color: blue;"><a href="<?php echo site_url('admin/update_shop_details');?>">Back</a></span></p>
                        
                         <select name="Selcountry" id="country" class="input-cc">
                          <option selected="selected" value="<?php echo $profile->country_id ; ?>" ><?php echo $profile->country_name ; ?></option>
                  <?php 
                  foreach($country as $row){

                    if ($profile->country_id == $row->id ) {
                  ...
                  <select name="CountryCodes" id="state" class="input-cc">
                     <option value="<?php echo $profile->CountryCode?>"><?php echo $profile->CountryCode?></option>
                  </select>

                        <div class="form-group">
                            <input type="text" class="form-1" id="WhatsappNumber" name="WhatsappNumber"  value=" <?php echo $profile->mobile_number;?>"  placeholder="Whatsapp Number *" required>
                        </div>
                          <p class="change_link">
...
<script>
 ...
 $('#WhatsappNumber_message').fadeOut(); 
