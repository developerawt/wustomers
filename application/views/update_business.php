...
<div class="right_col" role="main">
     ...
     <div class="alert alert-success alert-dismissible" id="timeupdate" >
     ...
     <div class="alert alert-danger alert-dismissible" id="timeupdate" >
          <button type="button" class="close" data-dismiss="alert">&times;</button>
          <strong><?php echo  $this->session->flashdata('Fmessage');?> </strong> 
     </div>
     <?php } ?>
     <div class="">
                              ...
                              <form id="myProducsForm" method="post"  enctype="multipart/form-data" action="<?php echo site_url('admin/update_shop_details') ;?>" data-parsley-validate class="form-horizontal form-label-left">
                                   ...
                                   <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-6">
                                             <input type="hidden" value="" id="Business_logo_url" name="Business_logo_url">
                                             <input id="cropzee-input" type="file" name="Business_logo" style="padding-bottom: 40px;"  class="form-control col-md-7 col-xs-12">
                                        </div>
                                        <p><img id="imagePreview" src="<?php echo base_url('/shop/shop_image/').$details->Business_logo?>" style="width: 50px;height:50px;" ></p>
                                   </div>
                                   <script>
                                   ...
                                   <div class="form-group"style="display: none;">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-6">
                                             <input type="file" name="background_image" style="padding-bottom: 40px;"  class="form-control col-md-7 col-xs-12">
                                        </div>
                                        <p><img src="<?php echo base_url('/shop/shop_business/').$details->background_image?>" style="width: 50px;height:50px;" ></p>
                                   </div>
                                   <div class="form-group">
