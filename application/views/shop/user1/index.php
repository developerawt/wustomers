...
<!DOCTYPE html>
        ...
        <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">
            ...
            <link rel='manifest' href='https://whatsapcampaigns.com/application/views/shop/user1/manifest.json'>
...
<!-- Section: Testimonials v.2 -->
  ...
  <script>
      if ('serviceWorker' in navigator) {
        navigator.serviceWorker.register('/application/views/shop/user1/service-worker.js', { scope: '/application/views/shop/user1/' }).then(function(registration) {
